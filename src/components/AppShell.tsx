...
export function AppShell({ children }: { children: ReactNode }) {
  const { profile, signOut, site, sites, tools, isPlatformAdmin, switchSite, courseCount, runsRounds } = useAuth()
  ...
  const groups = site
    ? navFor(role, { hideClinic, tools, platformAdmin: isPlatformAdmin, courses: courseCount > 0, runsRounds })
